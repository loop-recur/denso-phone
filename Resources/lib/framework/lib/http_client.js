LoopRecur.HttpClient = function() {
	...
	function post(url, params_or_call_backs, call_backs) {
		...
		params = call_backs.isData ? params : JSON.stringify(params);
...
// private
	...
	function prepare(method, url, call_backs) {
		...
		setHeaders(client, call_backs.isData, method);
		return client;
	}
	...
	function setHeaders(client, isData, method) {
		...
		if(!isData && (method != "GET")) client.setRequestHeader("content-type", "application/json");
	}
